...
<template>
    <div class="circle" style="--clr:#16ba0c;">   
        ...
        <div id="seconds"><span style='font-size:1.5em;'>00</span><br><span style='font-size:0.55em;'>{{ languagePack.pop_circle_second }}</span></div>  
    </div>
    <div class="popbuy-wait" v-if="load">
        <img width="50" class="popbuy-wait__icon" height="50" src="../assets/load.gif"/>
        <div class="popbuy-wait__data" ><span>{{ languagePack.pop_circle_caculating }}</span></div>
    </div>
</template>
<style scoped>
.circle{
